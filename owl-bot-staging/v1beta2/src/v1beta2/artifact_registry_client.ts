 ...
 */
   ...
   * @returns {string} Resource name string.
   */
  tagPath(project:string,location:string,repository:string,package:string,tag:string) {
   ...
   * @returns {string} Resource name string.
   */
  versionPath(project:string,location:string,repository:string,package:string,version:string) {
