...
export class ArtifactRegistryClient {
  ...
  initialize() {
    ...
    const artifactRegistryStubMethods =
        ['listRepositories', 'getRepository', 'createRepository', 'updateRepository', 'deleteRepository', 'listPackages', 'getPackage', 'deletePackage', 'listVersions', 'getVersion', 'deleteVersion', 'listFiles', 'getFile', 'listTags', 'getTag', 'createTag', 'updateTag', 'deleteTag', 'setIamPolicy', 'getIamPolicy', 'testIamPermissions'];
 ...
 *   for more details and examples.
 * @example
 * const decodedOperation = await checkCreateRepositoryProgress(name);
 ...
 *   for more details and examples.
 * @example
 * const decodedOperation = await checkDeleteRepositoryProgress(name);
 * console.log(decodedOperation.result);
 * console.log(decodedOperation.done);
 * console.log(decodedOperation.metadata);
 */
 ...
 *   for more details and examples.
 * @example
 * const decodedOperation = await checkDeletePackageProgress(name);
 * console.log(decodedOperation.result);
 * console.log(decodedOperation.done);
 * console.log(decodedOperation.metadata);
 */
 ...
 *   for more details and examples.
 * @example
 * const decodedOperation = await checkDeleteVersionProgress(name);
 * console.log(decodedOperation.result);
 * console.log(decodedOperation.done);
 * console.log(decodedOperation.metadata);
 */
