...
describe('v1beta2.ArtifactRegistryClient', () => {
    ...
    describe('getRepository', () => {
        it('invokes getRepository without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.devtools.artifactregistry.v1beta2.Repository());
    ...
    describe('getPackage', () => {
        it('invokes getPackage without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.devtools.artifactregistry.v1beta2.Package());
    ...
    describe('getVersion', () => {
        it('invokes getVersion without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.devtools.artifactregistry.v1beta2.Version());
    ...
    describe('getFile', () => {
        it('invokes getFile without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.devtools.artifactregistry.v1beta2.File());
    ...
    describe('getTag', () => {
        it('invokes getTag without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.devtools.artifactregistry.v1beta2.Tag());
    ...
    describe('getProjectSettings', () => {
        it('invokes getProjectSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.devtools.artifactregistry.v1beta2.GetProjectSettingsRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.devtools.artifactregistry.v1beta2.ProjectSettings());
    ...
    describe('updateProjectSettings', () => {
        it('invokes updateProjectSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.devtools.artifactregistry.v1beta2.UpdateProjectSettingsRequest());
    ...
    describe('importAptArtifacts', () => {
        it('invokes importAptArtifacts without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.devtools.artifactregistry.v1beta2.ImportAptArtifactsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('importYumArtifacts', () => {
        it('invokes importYumArtifacts without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.devtools.artifactregistry.v1beta2.ImportYumArtifactsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
